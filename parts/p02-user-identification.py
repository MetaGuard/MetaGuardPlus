...
NUM_USERS = 500                         # Number of users for identification
TRAIN_SIZE = 400                        # Number of samples for each class for training
TEST_SIZE = 100                         # Number of samples for each class for testing
