...
train_true = np.load("../data/user-similarity/train-true.npy")
train_false = np.load("../data/user-similarity/train-false.npy")
validate_true = np.load("../data/user-similarity/validate-true.npy")
validate_false = np.load("../data/user-similarity/validate-false.npy")
...
# Define the user similarity model architecture
...
model = keras.Model(inputs=[x1, x2], outputs=o, name='user-similarity')
...
print("Testing user similarity model...")
model.evaluate([testX1, testX2], testY, batch_size=BATCH_SIZE)

# Save model
print("Saving user similarity model...")
model.save('./models/user-similarity.keras')
