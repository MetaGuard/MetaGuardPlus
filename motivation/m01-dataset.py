...
MIN_REPLAYS = 800                       # Minimum number of replays per user for inclusion
NUM_USERS =  500                        # Number of users to include
NUM_REPLAYS = 500                       # Number of replays per user to include
